...
//The URL to the truck location data.
...
var listItemTemplate = '<div class="listItem" onclick="itemSelected(\'{id}\')"><div class="listItem-title">{title}</div>{city}<br />Hours {DaysHours}<br />{distance} miles away</div>';

function initialize() {
    //Initialize a map instance.
    map = new atlas.Map('myMap', {
        center: [-122.419418, 37.774929],
        zoom: 12,
    ...
    map.events.add('ready', function () {
        ...
        //Create a data source and add it to the map and disable clustering.
        ...
        map.imageSprite.add('myCustomIcon', iconImageUrl).then(function () {
            ...
            //When the mouse is over the icon layers, change the cursor to be a pointer.
            map.events.add('mouseover', [iconLayer], function () {
                map.getCanvasContainer().style.cursor = 'pointer';
            });
           

            //When the mouse leaves the item on the icon layers, change the cursor back to the default which is grab.
            map.events.add('mouseout', [iconLayer], function () {
    ...
    if (camera.zoom < maxClusterZoomLevel) {
        ...
        /*
            ...
            <div class="listItem" onclick="itemSelected('id')">
                <div class="listItem-title">Microsoft</div>
                1 Microsoft Way<br/>
                Redmond, WA 98052<br />
       ...
       data.forEach(function (shape) {
            ...
            html.push('<div class="listItem" onclick="itemSelected(\'', shape.getId(), '\')"><div class="listItem-title">',
                ...
                //Get a formatted address line 2 value that consists of Address, City, Municipality, AdminDivision, and PostCode.
                getAddressLine(properties),
                '<br />',

                //Get Hours of operation.  ToDo:  Introduce formatting
...
function getOpenTillTime(properties) {
    ...
    return 'Hours of Operation' + properties['DaysHours'];
}
...
function getAddressLine(properties) {
